...
public class PostCommentHeartService {
    ...
    @Transactional
    public ResponseDto<?> createPostCommentHeart(HeartRequestDto requestDto, HttpServletRequest request) {
        ...
        PostCommentHeart postcommentheart = PostCommentHeart.builder()
                .member(member)
                .comment(comment)
                .build();
        postCommentHeartRepository.save(postcommentheart);
